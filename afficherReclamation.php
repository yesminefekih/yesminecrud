          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Afficher les réclamations</h5>
              ...
              <section  class="card-body" style="width:2000px;height:2000px;">
            <h4>Réclamation:</h4>
              <div class="col-md-3 pr-md-1">
                <div class="form-group"   >    
              <form method="get">
                      <table>
                      <?php foreach ($listeReclamations as $rec):?>
                      <thead>
                      <tr>
                      <th scope="col" >Nom:</th>
                      <th scope="col">Prenom:</th>
                      <th scope="col">Identifiant client:</th>
                      <th scope="col">Num° de téléphone:</th>
                      <th scope="col">Adresse mail:</th>
                      <th scope="col">Num° de facture:</th>
                      ...
                      <td><?PHP echo $rec['Identifiant'] ?></td>  
                      <td><?PHP echo $rec['Num'] ?></td>
                      <td><?PHP echo $rec['Mail'] ?></td>
                      <td><?PHP echo $rec['Facture'] ?></td>
                      <td><?PHP echo $rec['Objet'] ?></td>
                      <td><?PHP echo $rec['Description'] ?></td>
                      <td><?PHP echo $rec['Etat'] ?></td>
                      <td><?PHP echo $rec['Note'] ?></td>
                      <!--<tr>
                        <td>
                            <label>Nom: <?PHP //echo $rec['Nom'] ?></label>
                            <label>Prenom: <?PHP //echo $rec['Prenom'] ?></label>
                            <label>Identifiant client:<?PHP //echo $rec['Identifiant'] ?></label> 
                            <label>Num° de téléphone: <?PHP //echo $rec['Num'] ?></label>
                            <label>Adresse mail: <?PHP //echo $rec['Mail'] ?></label>
                            <label>Num° de facture: <?PHP //echo $rec['Facture'] ?></label>
                            <label>Date: <?PHP //echo $rec['Dat'] ?></label>
                            <label>Objet: <?PHP //echo $rec['Objet'] ?></label>
                            <label>Description: <?PHP //echo $rec['Description'] ?></label>
                            <label>Etat: <?PHP //echo $rec['Etat'] ?></label> </br>
                            <label>Note: <?PHP //echo $rec['Note'] ?></label>
                        </td>
                        </tr> -->       
                        <!--<tr>-->
                              <form method="POST" action="supprimerReclamation.php">
                              <td><input type="submit" class="btn btn-primary btn-block btn-round" name="supprimer" value="supprimer"></td>
                              <input type="hidden" class="btn btn-primary btn-block btn-round" value="<?PHP echo $rec['Identifiant']; ?>" name="Identifiant">
                              </form>
                              <form>
                              <td><a class="btn btn-primary btn-block btn-round" href="modifierReclamation.php?Identifiant=<?PHP echo $rec['Identifiant']; ?>"> Modifier</a></td>
                              <td><a class="btn btn-primary btn-block btn-round" href="mail.php"> Envoyer mail</a></td>
                              </form>                        
                        <!--</tr>-->
